...
export default function BakeCardLvlTwo() {
    ...
    const createStatus = localStorage.getItem('createdStatus11') === 'created' ? true : false
    const createStatusPool = localStorage.getItem('createdPool11') === 'created'? true: false
    ...
    const onStake = async () => {
        ...
        if (TVL + Number(stakeAmount) > STAKING[1].LIMIT) {
    ...
    const onUnstake = async () => {
        ...
        try {
            setUnStaking(true)
            await unstake(wallet, unStakeAmount, tokenMint, referral, STAKING_IDS[1])
        } catch (e) {
            ...
            <CardContent className="fact">
                ...
                >
                    ...
                    <Typography
                        ...
                        style={{ fontFamily: 'Montserrat' }}
                    >
                        {config.LEVEL_TWO_LOCK_TIME} months
                    </Typography>
                </UnderlinedGrid>
                <UnderlinedGrid
                    container
